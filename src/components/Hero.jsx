...
import { ChevronDown, Users, Briefcase, Target, BarChart3, Linkedin } from 'lucide-react'
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm text-primary-400 font-medium">Workday Financials Recruiter</span>
            </motion.div>
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl font-bold leading-tight">
                Hi, I'm{' '}
                <span className="gradient-text">Aidan Carter</span>
              </h1>
            </motion.div>
            ...
            >
              Business Management graduate from Framingham State University and Workday Financials
              Recruiter at ALKU. Passionate about connecting top talent with leading organizations
              and driving recruitment excellence in the Workday ecosystem.
            </motion.p>
            ...
            >
              <a href="/documents/Aidan-Carter-Resume.pdf" target="_blank" rel="noopener noreferrer" className="btn-primary">
                View My Resume
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" className="btn-secondary flex items-center gap-2 relative z-10">
                <Linkedin size={20} />
                LinkedIn
              </a>
            </motion.div>

            {/* Core Skills Icons - hidden on mobile */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <span className="text-dark-500 text-sm">Core Skills:</span>
              <div className="flex items-center gap-3 sm:gap-4">
                {[
                  { icon: Users, label: 'Recruiting' },
                  { icon: Briefcase, label: 'Business Mgmt' },
                  { icon: Target, label: 'Talent Acquisition' },
                  { icon: BarChart3, label: 'Workday Financials' },
                ].map(({ icon: Icon, label }) => (
                  <motion.div
                    key={label}
          ...
          {/* Desktop - Profile Image & Spec Card */}
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: 1, x: 0 }}
            ...
            <div className="relative flex flex-col gap-6">
              <div className="relative w-[60%] mx-auto">
                ...
                <div className="relative glass rounded-2xl overflow-hidden p-2">
                  <ImageWithLoader
                    src="/images/profile/aidan.jpg"
                    alt="Aidan Carter - Business Management Professional"
                ...
                >
                  <span className="text-primary-400 font-mono text-xs">3.43 GPA</span>
                </motion.div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative glass rounded-2xl overflow-hidden">
                  <div className="flex items-center gap-2 px-4 py-3 bg-dark-900/80 border-b border-dark-700/50">
                    ...
                    <span className="text-dark-500 text-sm font-mono ml-2">recruiter.spec</span>
                  </div>
                ...
                >
                  <span className="text-orange-400 font-mono text-sm">FSU '23</span>
                </motion.div>
              </div>
            </div>
          </motion.div>
